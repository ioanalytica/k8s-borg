...
### 8.7 Workstream register (state 2026-09-11)
...
- **W6-backend** shipped before the frontend (#967, #975); phase 9 (#1010,
  2026-09-11) has since deleted the legacy tables and `legacy_status.py`,
  so **W6-frontend / W13 (#981)** reads the operations model only.
